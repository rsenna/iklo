...
>
> Converted from the original plain text to Markdown on 2026-07-10.
> **The prose is unmodified** — only headings, the table of contents, and code fences
> were added, plus backslash-escapes where literal `#` or `*` would otherwise render as
> Markdown.
...
- [1. Review of metacircular evaluator](#1-review-of-metacircular-evaluator)
  - [1.1 Recursive structure of the evaluator](#11-recursive-structure-of-the-evaluator)
  - [1.2 Tail call elimination in the MCE](#12-tail-call-elimination-in-the-mce)
- [2. The Explicit-Control Evaluator](#2-the-explicit-control-evaluator)
  - [2.1 Typical C-style procedure calling convention](#21-typical-c-style-procedure-calling-convention)
  - [2.2 Procedure calling convention in the ECE](#22-procedure-calling-convention-in-the-ece)
  - [2.3 The evaluator uses surprisingly few registers](#23-the-evaluator-uses-surprisingly-few-registers)
  - [2.4 The two-screenful version of the explicit control evaluator](#24-the-two-screenful-version-of-the-explicit-control-evaluator)
  - [2.5 Implementing explicit control in C](#25-implementing-explicit-control-in-c)
- [3. Complicating Issues in UCBLogo](#3-complicating-issues-in-ucblogo)
  - [3.1 Commands vs. operations](#31-commands-vs-operations)
  - [3.2 Error messages and tail call elimination](#32-error-messages-and-tail-call-elimination)
    - [3.2a Tailforms](#32a-tailforms)
    - [3.2b Tailforms handled as embedded calls](#32b-tailforms-handled-as-embedded-calls)
    - [3.2c Caller-status arguments to eval-sequence and eval-dispatch](#32c-caller-status-arguments-to-eval-sequence-and-eval-dispatch)
    - [3.2d Detecting errors before they happen](#32d-detecting-errors-before-they-happen)
  - [3.3 Macros](#33-macros)
    - [3.3a Why the MCE uses special forms](#33a-why-the-mce-uses-special-forms)
    - [3.3b Using rewriting instead of special forms](#33b-using-rewriting-instead-of-special-forms)
    - [3.3c Logo continuations](#33c-logo-continuations)
  - [3.4 Dynamic scope](#34-dynamic-scope)
    - [3.4a Reasons for lexical scope](#34a-reasons-for-lexical-scope)
    - [3.4b Reasons for dynamic scope](#34b-reasons-for-dynamic-scope)
    - [3.4c Shallow binding](#34c-shallow-binding)
  - [3.5 Nonlocal exit](#35-nonlocal-exit)
  - [3.6 Lack of parentheses delimiting procedure calls](#36-lack-of-parentheses-delimiting-procedure-calls)
    - [3.6a Tokenization](#36a-tokenization)
    - [3.6b Monadic and dyadic minus](#36b-monadic-and-dyadic-minus)
    - [3.6c More on runparsing](#36c-more-on-runparsing)
    - [3.6d Treeification](#36d-treeification)
    - [3.6e Procedure bodies](#36e-procedure-bodies)
    - [3.6f Changing a procedure's arity](#36f-changing-a-procedures-arity)
- [4. Data structures and types](#4-data-structures-and-types)
  - [4.1 Pair-based types](#41-pair-based-types)
  - [4.2 Numeric types](#42-numeric-types)
  - [4.3 String types](#43-string-types)
    - [4.3a Internal structure of a string](#43a-internal-structure-of-a-string)
    - [4.3b How to create a string node](#43b-how-to-create-a-string-node)
    - [4.3c Including punctuation characters in words](#43c-including-punctuation-characters-in-words)
  - [4.4 Symbols](#44-symbols)
  - [4.5 Quote and colon types](#45-quote-and-colon-types)
  - [4.6 Arrays](#46-arrays)
  - [4.7 Primitive procedures](#47-primitive-procedures)
- [5. Garbage collector](#5-garbage-collector)
  - [5.1 Node allocation](#51-node-allocation)
  - [5.2 The mark phase](#52-the-mark-phase)
  - [5.3 GCTWA](#53-gctwa)
  - [5.4 The sweep phase](#54-the-sweep-phase)
  - [5.5 Per-node gc data](#55-per-node-gc-data)
