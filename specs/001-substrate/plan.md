...
- **VI. ADRs for Load-Bearing Decisions** ✅ — grounded in [ADR-0001](../../spec/decisions/ADR-0001-substrate-boundary.md). Any new load-bearing sub-decision during implementation becomes ADR-0002.
